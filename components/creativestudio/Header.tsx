...
export const Header: React.FC<HeaderProps> = ({ onOpenLibrary, onOpenTrainer, currentTheme, onChangeTheme }) => {
  ...
  return (
    <header className="flex items-center justify-between gap-4 mb-6">
      ...
      <div className="flex flex-shrink-0 justify-end items-center gap-2 sm:gap-4">
        ...
        >
             ...
             <span className="hidden sm:inline">{t('aiStudio.header.trainer')}</span>
        </button>
         <button 
        ...
        >
             ...
             <span className="hidden sm:inline">{t('aiStudio.library.title')}</span>
        </button>
      </div>
    </header>
  );
