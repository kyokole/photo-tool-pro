        ...
        <div className="flex items-center space-x-3 px-2">
          {history.map(item => (
            <div
              ...
              className={`flex-shrink-0 w-20 h-20 rounded-lg cursor-pointer p-0.5 transition-all duration-200 ${currentImage === item.imageDataUrl ? 'bg-[var(--accent-blue)]' : 'bg-transparent'}`}
            >
              <img
