...
const placeholderImage = genericIconUrl;
...
const appleLightingStyles: BeautyStyle[] = [
    { id: 'none', labelKey: 'beautyStudio.styles.none', englishLabel: 'None', type: 'image', value: placeholderImage },
...
const skinToneVariants = [
    ...
    { id: 'STV_LIGHT_WARM', name: 'Light Warm (Golden-Peach)' },
    { id: 'STV_LIGHT_MEDIUM_NEUTRAL', name: 'Light Medium Neutral (Neutral-Beige)' },
    { id: 'STV_MEDIUM_WARM', name: 'Medium Warm (Golden-Olive)' },
    { id: 'STV_TAN_COOL', name: 'Tan Cool (Rosa-Beige)' },
    { id: 'STV_DEEP_TAN_WARM', name: 'Deep Tan Warm (Golden-Amber)' },
    { id: 'STV_RICH_NEUTRAL', name: 'Rich Neutral (Neutral-Brown)' },
    { id: 'STV_DEEP_COOL', name: 'Deep Cool (Rosa-Brown)' },
    { id: 'STV_ESPRESSO_WARM', name: 'Espresso Warm (Golden-Deep Brown)' },
];
...
const skinToneAdjustmentStyles: BeautyStyle[] = [
    ...
    ...skinToneVariants.map((variant): BeautyStyle => ({
        id: variant.id,
        labelKey: `beautyStudio.styles.${variant.id}`, // Placeholder, needs actual i18n key
        englishLabel: variant.name,
        type: 'image',
        value: genericIconUrl,
...
export const BEAUTY_FEATURES: BeautyFeature[] = [
    ...
    {
        id: 'hd_quality', labelKey: 'beautyStudio.tools.hd_quality', englishLabel: 'Image Quality', badge: 'NEW', icon: "fa-solid fa-star",
        promptInstruction: "Enhance the overall image quality to High Definition. Sharpen details, improve clarity, and upscale the resolution while maintaining a natural look."
    },
    {
        id: 'beautify', labelKey: 'beautyStudio.tools.beautify', englishLabel: 'Beautify', badge: 'Hot', icon: "fa-solid fa-magic",
        subFeatures: [
            { id: 'smooth_skin', labelKey: 'beautyStudio.subfeatures.smooth_skin', englishLabel: 'Smooth Skin', promptInstruction: "Apply professional skin smoothing. Remove minor blemishes and oily shine, but preserve natural skin texture.", styles: intensityStyles },
        ]
    },
    {
        id: 'skin_tone_adjustment', labelKey: 'beautyStudio.tools.skin_tone_adjustment', englishLabel: 'Skin Tone', icon: "fa-solid fa-palette",
        subFeatures: [
            { id: 'skin_tone_presets', labelKey: 'beautyStudio.subfeatures.skin_tone_presets', englishLabel: 'Presets', styles: skinToneAdjustmentStyles },
        ]
    },
    {
        id: 'remove_bg', labelKey: 'beautyStudio.tools.remove_bg', englishLabel: 'Remove BG', icon: "fa-solid fa-scissors",
        promptInstruction: "Carefully cut out the main subject from the image and place them on a transparent background. The edges must be clean and precise."
    },
    {
        id: 'ai_portrait', labelKey: 'beautyStudio.tools.ai_portrait', englishLabel: 'AI Portrait', badge: 'NEW', icon: "fa-solid fa-user-check",
    },
    {
        id: 'hair', labelKey: 'beautyStudio.tools.hair', englishLabel: 'Hair', icon: "fa-solid fa-brush",
    },
    {
        id: 'expand_bg', labelKey: 'beautyStudio.tools.expand_bg', englishLabel: 'Expand BG', icon: "fa-solid fa-expand",
    },
    {
        id: 'expression', labelKey: 'beautyStudio.tools.expression', englishLabel: 'Expression', badge: 'Hot', icon: "fa-solid fa-smile",
        subFeatures: [
            { id: 'expression_sub', labelKey: 'beautyStudio.subfeatures.expression_sub', englishLabel: 'Smile Adjustment', styles: smileStyles },
        ]
    },
    {
        id: 'id_photo', labelKey: 'beautyStudio.tools.id_photo', englishLabel: 'ID Photo', icon: "fa-solid fa-id-card",
        subFeatures: [
    ...
    {
        id: 'makeup', labelKey: 'beautyStudio.tools.makeup', englishLabel: 'Makeup', icon: "fa-solid fa-paint-brush",
        subFeatures: [
             {
                id: 'son_moi', labelKey: 'beautyStudio.subfeatures.lipstick', englishLabel: 'Lipstick',
