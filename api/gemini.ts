...
const WATERMARK_BASE64 = "-f"
...
async function applyWatermark(generatedImageBase64: string, originalMimeType: string): Promise<{ data: string, mimeType: string }> {
    try {
        ...
        if (!mainWidth || !metadata.height) {
            throw new Error('Could not read image metadata for watermarking.');
        }

        const watermarkWidth = Math.floor(mainWidth * 0.25);
        ...
        const padding = Math.floor(mainWidth * 0.03);
        ...
        return { data: finalBuffer.toString('base64'), mimeType: originalMimeType };
    } catch (error) {
